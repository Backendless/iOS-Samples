...
- (void)windowControllerDidLoadNib:(NSWindowController *) aController
{
    ...
    [backendless.persistenceService find:[Task class] dataQuery:[BackendlessDataQuery query] response:^(BackendlessCollection *collection) {
...
-(void)removeTask:(NSTableView *)sender
{
    ...
    [backendless.persistenceService remove:[Task class] sid:[task valueForKey:@"objectId"] response:^(id res) {
...
-(void)checkStatus:(NSTableView *)sender
{
    ...
    [backendless.persistenceService save:task response:^(id res) {
