...
@class MessageStatus, PublishOptions, DeliveryOptions, SubscriptionOptions, Subscription;
@protocol IResponder;
...
-(Subscription *)subscribe:(NSString *)channelName;
-(Subscription *)subscribe:(NSString *)channelName subscriptionResponder:(id <IResponder>)subscriptionResponder;
-(Subscription *)subscribe:(NSString *)channelName subscriptionResponder:(id <IResponder>)subscriptionResponder subscriptionOptions:(SubscriptionOptions *)subscriptionOptions;
-(Subscription *)subscribe:(Subscription *)subscription subscriptionOptions:(SubscriptionOptions *)subscriptionOptions;
...
-(void)subscribe:(Subscription *)subscription subscriptionOptions:(SubscriptionOptions *)subscriptionOptions responder:(id <IResponder>)responder;
